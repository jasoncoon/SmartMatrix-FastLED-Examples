// Mark Kriegsman's NoisePlusPalette FastLED example
// https://github.com/FastLED/FastLED/blob/FastLED2.1/examples/NoisePlusPalette/NoisePlusPalette.ino
// slightly modified to run on a 32x32 RGB LED Matrix and Teensy v3.1 using SmartMatrix library
